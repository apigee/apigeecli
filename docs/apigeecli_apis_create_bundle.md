...
```
  ...
  -p, --proxy string              Path to the apiproxy folder
  -z, --proxy-zip string          Path to the API Proxy bundle/zip file
  -f, --proxy-zip-folder string   Path to write the API Proxy Bundle
```
