...
```
  ...
  -u, --owner string        The github organization or username. ex: In https://github.com/username, username is the github username
  -p, --proxy-path string   The path in the repo to the apiproxy folder. ex: my-repo/apiproxy
  -r, --repo string         The github repo name. ex: https://github.com/apigee/sample-apps, sample-apps is the repo
```
