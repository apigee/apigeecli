...
var CreateArtifactCmd = &cobra.Command{
	Use:   "create",
	Short: "Create an artifact for an API",
	Long:  "Create an artifact for an API Apigee Registry Instance",
	...
	RunE: func(cmd *cobra.Command, args []string) (err error) {
		...
		_, err = apis.CreateArtifact(apiName, artifactID, name, contents, labels, annotations)
		return err
	},
}

var (
	name, artifactID, contentsFile string
