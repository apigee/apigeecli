...
var DelArtifactCmd = &cobra.Command{
	Use:   "delete",
	Short: "Delete artifact for a spec in an API version",
	Long:  "Delete artifact for a spec in an API version in Apigee Registry",
	...
	RunE: func(cmd *cobra.Command, args []string) (err error) {
		_, err = versions.DeleteSpecArtifact(apiName, apiVersion, specName, name)
		return
	},
}
...
func init() {
	...
	DelArtifactCmd.Flags().StringVarP(&apiVersion, "api-version", "",
		"", "API Version")
	DelArtifactCmd.Flags().StringVarP(&specName, "spec-name", "",
	...
	_ = DelArtifactCmd.MarkFlagRequired("spec-name")
