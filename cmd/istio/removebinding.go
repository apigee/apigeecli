...
var RemoveCmd = &cobra.Command{
	Use:   "remove",
	Short: "Removes an Istio binding from an API Product",
	Long:  "Removes an Istio binding from an API Product",
	...
	RunE: func(cmd *cobra.Command, args []string) (err error) {
		...
		respBody, err := products.GetAttribute(productName, istioAttributeName)
		if err != nil {
			return err
		}
		...
		_, err = products.UpdateAttribute(productName, istioAttributeName, newAttributeValues)
		return err
	},
}
