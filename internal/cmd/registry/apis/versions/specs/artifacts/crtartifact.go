...
var CreateArtifactCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) (err error) {
		...
		_, err = versions.CreateSpecArtifact(apiName, apiVersion, specName, artifactID, name, contents, labels, annotations)
		return err
	},
}
...
var artifactID, contentsFile string
...
func init() {
	...
	CreateArtifactCmd.Flags().StringVarP(&specName, "spec-name", "",
	...
	_ = CreateArtifactCmd.MarkFlagRequired("spec-name")
