...
var ListCmd = &cobra.Command{
	Use:   "list",
	Short: "List Specs for an API Version",
	Long:  "List Specs for an API Version",
...
var (
	pageSize                            int
	pageToken, filter, apiID, versionID string
)

func init() {
	ListCmd.Flags().StringVarP(&versionID, "version", "v",
		"", "API Version ID")
	ListCmd.Flags().StringVarP(&apiID, "api-id", "",
		"", "API ID")
	...
	_ = ListCmd.MarkFlagRequired("version")
}
